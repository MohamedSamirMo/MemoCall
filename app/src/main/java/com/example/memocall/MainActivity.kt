...
class MainActivity : AppCompatActivity() {
    ...
    private val token ="007eJxTYMjLaH7qr5R9wHRt+ceH3qqyh/9sVQzPUCzc55p0a4b8Zz4FBnMDIDQztEgxNU0ySUw1SbQwtkhMtjA0MU+1MDIzSLnSdzilIZCRYVmqKQsjAwSC+BwMuam5+cmJOTkMDAC05SCu"
    private val uid = 0
